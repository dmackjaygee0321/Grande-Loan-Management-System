...
namespace Offline_lendingmanagementsystem_Its
{
    public partial class dialogupdate : Form
    {
        ...
        public void display()
        {
            ...
            string strAcct = "Select * from customerinfo where No like '%" + updateborrowerinfo.search.Replace("'", "''") + "%'|| concat (LastName,' ',FirstName,' ',MiddleName) like '%" + updateborrowerinfo.search.Replace("'", "''") + "%'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            updateborrowerinfo.id = dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[0].Value.ToString();
