...
namespace Offline_lendingmanagementsystem_Its
{
    public partial class breport : Form
    {
        ...
        private void breport_Load(object sender, EventArgs e)
        {
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Empty Records", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
